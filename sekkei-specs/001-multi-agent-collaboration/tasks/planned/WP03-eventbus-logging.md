...
- [ ] Benchmarks prove <1μs publish, >10k events/sec
- [ ] Unit tests pass with race detector
- [ ] Integration test exercises full EventBus + Logger
- [ ] Graceful shutdown tested (no goroutine leaks)
- [ ] Event logger writes valid JSON to orchestrator.log
