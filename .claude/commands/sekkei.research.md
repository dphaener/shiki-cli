...
Scaffolds research artifacts before task planning.
...
5. Summarize open questions or risks at the bottom of `research.md`. These should feed directly into `/sekkei.tasks` and future implementation prompts.

## Success Criteria

- `sekkei-specs/<feature>/research.md` explains every major decision with references to evidence.
- `sekkei-specs/<feature>/data-model.md` lists the entities and relationships needed for implementation.
