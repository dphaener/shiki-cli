...
scripts:
  sh: .sekkei/scripts/bash/accept-feature.sh --json {ARGS}
  ps: .sekkei/scripts/powershell/accept-feature.ps1 --json {ARGS}
---
...
Validates feature readiness and guides final acceptance steps.
